    ...
    return (
      <div>
        <div className="container xl:max-w-[1100px] my-12">
          <div className="flex justify-between sm:gap-4 items-center p-4 sm:px-4 sm:py-4 bg-cyan-900 my-6 rounded-2xl">
            <div className="sm:bg-white sm:p-4 sm:rounded-xl">
              <svg
                className="fill-white sm:fill-cyan-900 sm:w-10 sm:h-10"
            ...
            <div className="flex justify-evenly items-center gap-1 p-2 rounded-xl bg-white">
              <span>
                <svg
                  xmlns:xlink="http://www.w3.org/1999/xlink"
                  width="20"
